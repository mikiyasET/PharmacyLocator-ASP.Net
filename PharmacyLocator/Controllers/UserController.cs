    ...
    public class UserController : Controller
    {
        ...
        public async Task<string> Search(string query)
        {
            ...
            if (await _medservice.NameExist(m))
            {
                ...
                {
                    response += "<div class='row'><input type='hidden' value='exists'>";
